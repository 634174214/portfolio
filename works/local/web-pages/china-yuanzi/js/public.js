...
function pcNav(){
   ...
   secondMenu.each(function(index,item){
      var item_a = $(item).find('a'),
          item_a_w = item_a.outerWidth();
      var thisWidth = item_a.size()* item_a_w;
...
if(mainArticle.length > 0){
  var aImgs = mainArticle[0].getElementsByTagName("img");
  if (aImgs.length>0) {
     t_pic = aImgs[0].src;
  } else {
      t_pic = 'http://vip.qdxin.cn/lin/wb/sshare/share.jpg';
  }
} else {
      t_pic = 'http://vip.qdxin.cn/lin/wb/sshare/share.jpg';
}
