...
Goindex=function(){
  ...
  var logoa=$('<a href="index.html" target="_blank" class="go-index"></a>');
 $('.logo').append(logoa);
 var logoL=-($('.logo').offset().left-10);
 $('.go-index').css('left',logoL);
}


$(document).ready(function(){
       Navpc();Navm();ShowMnav();columnHM();fixedBar();Goindex();
})