    ...
    loading.prototype = {
        ...
        _style: function() {
            ...
            var style = `
                ...
                #loading-${suffix} .load i{display: block;text-align: center;color: ${this.fontColor};margin-bottom: 10px;font-style: normal;}
...
var PreLoading = new Loading({
    ...
    'images/3.png',
    'images/bj.jpg',
    'images/count-begin-bg.jpg',
    'images/count-down-1.png',
    'images/count-down-2.png',
    'images/count-down-3.png',
    'images/count-down-begin.png',
    'images/final-again.png',
    'images/final-btn.psd',
    'images/final-jump.png',
    'images/final-man.png',
    'images/ren.png',
    'images/score-bg.png',
    'images/shuoming-close.png',
    'images/start-bg.jpg',
    'images/start-btn.png',
    'images/start-man.png',
    'images/start-page.psd',
    'images/start-shuoming.png',
    'images/time-bg.png',
    'images/title-1.png'
    ],
    autoHide: true,
