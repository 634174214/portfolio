(function(window) {
	...
	function init() {
		...
		/* Icon 9 */
		var el9 = $iconBox[0].querySelector('button.icobutton'), el9span = el9.querySelector('span');
		...
		new Animocon(el9, {
			tweens : [
				...
				new mojs.Burst({
					...
					delay: 350,
					shape : 'circle',
					fill : [ '#ffc000', '#DE8AA0', '#8AAEDE', '#8ADEAD', '#DEC58A', '#8AD1DE' ],
					x: '50%',
					y: '50%',
					opacity: 0.6,
					radius: {40:90},
